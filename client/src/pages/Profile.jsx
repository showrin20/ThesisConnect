...
import { getStatusStyles } from '../styles/styleUtils'; // Import for error styling
...
export default function Profile() {
  ...
  const [profileUser, setProfileUser] = useState(null); // Store the profile being viewed
  ...
  // Fetch another user's profile if userId is provided and it's not the current user
  useEffect(() => {
    ...
    return (
      <div className="min-h-screen" style={{ backgroundColor: c.background.primary }}>
        <div className="flex justify-center items-center h-screen">
          <div className="animate-pulse text-xl" style={{ color: c.text.primary }}>
            Loading...
          </div>
        </div>
      </div>
  ...
  if (profileError) {
    return (
      <div className="min-h-screen" style={{ backgroundColor: c.background.primary }}>
        <div className="flex justify-center items-center h-screen">
          <div className="max-w-md w-full p-6 rounded-lg" style={getStatusStyles('error')}>
      ...
      <div className="min-h-screen" style={{ backgroundColor: c.background.primary }}>
        <div className="relative flex h-screen">
          ...
          <div className="flex-1 flex flex-col lg:ml-0">
            <Topbar onMenuToggle={() => setSidebarOpen(!sidebarOpen)} user={authUser} onLogout={handleLogout} isLoggingOut={isLoggingOut} />
          ...
          <main className="flex-1 overflow-y-auto p-6">
            <div className="container mx-auto px-4 py-12">
              <div className="max-w-4xl mx-auto rounded-xl shadow-lg p-8"
                ...
                <h1 className="text-3xl font-bold text-center mb-8" style={{ color: c.text.primary }}>
